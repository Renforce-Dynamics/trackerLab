...
from robotlib.unitree_rl_lab.unitree import UNITREE_H1_CFG
from locomotion_rl_lab.tasks.locomotion import mdp
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = UNITREE_H1_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
