...
from robotlib.trackerLab.assets.humanoids.pi_plus import PI_PLUS_21DOF_CFG
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = PI_PLUS_21DOF_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
