...
@configclass
class PiRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    rewards: PiRewards = PiRewards()
...
@configclass
class PiRoughEnvCfg_PLAY(PiRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class PiFlatEnvCfg(PiRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
class PiFlatEnvCfg_PLAY(PiFlatEnvCfg):
